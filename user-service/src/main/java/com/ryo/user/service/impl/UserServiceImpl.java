package com.ryo.user.service.impl;

import com.cloudinary.Cloudinary;
import com.cloudinary.utils.ObjectUtils;
import com.ryo.user.dto.request.EditUserRequest;
import com.ryo.user.dto.response.UserResponse;
import com.ryo.user.exception.AppException;
import com.ryo.user.exception.ErrorCode;
import com.ryo.user.repository.UserRepository;
import com.ryo.user.entity.User;
import com.ryo.user.mapper.UserMapper;
...
public class UserServiceImpl {
    ...
    public void changeUserPassword(String newPassword){
        ...
        User user  = userRepository.findById(username).orElseThrow(() -> new AppException(ErrorCode.USER_NOT_EXISTED));
