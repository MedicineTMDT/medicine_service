...
public class CategoryDetailControllerTest {
    ...
    void create() throws Exception {
        ...
        mockMvc.perform(post("/api/v1/category-detail")
                        .with(csrf())
    ...
    void update() throws Exception {
        ...
        mockMvc.perform(put("/api/v1/category-detail/1")
                        .with(csrf())
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(content))
                .andExpect(status().isOk())
    ...
    void deleteCate() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/category-detail/1")
                        .with(csrf()))
                .andExpect(status().isOk())
    ...
    void getOne() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/category-detail/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("code").value(1000))
    ...
    void getByCategory() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/category-detail/by-category/1")
                        .param("page", "0")
                        .param("size", "10"))
                .andExpect(status().isOk())
    ...
    void searchByName() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/category-detail/search")
                        .param("name", "para")
                        .param("page", "0")
                        .param("size", "10"))
                .andExpect(status().isOk())
    ...
    void getAll() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/category-detail")
                        .param("page", "0")
                        .param("size", "10"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("result.content[0].name").value("Paracetamol"));
