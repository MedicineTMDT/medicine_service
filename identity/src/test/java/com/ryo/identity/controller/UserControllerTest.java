...
public class UserControllerTest {
    ...
    void getUserByUsername_happyPath() throws Exception {
        ...
        // When Then
        mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/v1/users/username/tung123"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("code").value(1000))
                .andExpect(MockMvcResultMatchers.jsonPath("result.username")
                        .value("tung123"))
    ...
    void getUserByUsername_notFound_returnsError() throws Exception {
        ...
        // When Then
        mockMvc.perform(MockMvcRequestBuilders
                        .get("/api/v1/users/username/unknown"))
                .andExpect(MockMvcResultMatchers.status().isBadRequest());
    }
    ...
    // ════════════════════════════════════════════════════════════
    //  PUT /api/v1/users/edit  — EDIT USER INFO
    // ════════════════════════════════════════════════════════════
    ...
    // ════════════════════════════════════════════════════════════
    //  PUT /api/v1/users/update-avatar-img  — UPDATE AVATAR
    // ════════════════════════════════════════════════════════════
